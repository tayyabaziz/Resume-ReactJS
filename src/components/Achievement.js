...
import icon_achievement from '../assets/icons/icon-achievement.svg';

function Achievement() {
    return (
        <div className="col-12 mt-2">
            <h2 className="title title--h3"><img className="title-icon" src={icon_achievement} alt="" /> ACHIEVEMENT <hr /></h2>
